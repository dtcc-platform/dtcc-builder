...
//./ogr2ogr -f GeoJSON  -s_srs EPSG:3006 -t_srs EPSG:3006 /tmp/PropertyMap.geojson /tmp/PropertyMap.shp
...
int main(int argc, char* argv[])
{
	...
	ogr.close();	
	system(("ogr2ogr -f GeoJSON  -s_srs EPSG:3006 -t_srs EPSG:3006 "+ fileout+" "+filein).c_str());
	return 0;
}
