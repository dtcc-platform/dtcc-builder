 ...
 *     <li>Class Hierarchy: a textual representation of the FBX SDK class
 * structure <li>Graphical Class Hierarchy: a graphical representation of the
 * FBX SDK class structure <li>File List: an alphabetical list of all documented
 * header files</ul> <p> \section otherdocumentation Other Documentation Apart
 * from this reference guide, an FBX SDK Programming Guide and many FBX SDK
 * examples are also provided. <p> \section aboutFBXSDK About the FBX SDK The
 * FBX SDK is a C++ software development kit (SDK) that lets you import and
 * export 3D scenes using the Autodesk FBX file format. The FBX SDK reads FBX
 * files created with FiLMBOX version 2.5 and later and writes FBX files
 * compatible with MotionBuilder version 6.0 and up.
 */
