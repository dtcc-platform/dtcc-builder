...
/** The class and its derived classes(e.g. FbxProcessorXRefCopy,
 * FbxProcessorXRefCopyUserLibrary, etc.) are used to process shader, library,
 * asset, etc. For example, you could update object property and its value via
 * FbxProcessor::ProcessObject(), FbxProcessor::internal_ProcessObject(), etc.
 */
