...
/** Class for exclusive collections. An object (FbxObject) should belong to only
 * one exclusive collection at most. \nosubgrouping
 */
...
public:
  /** Add a member if it's not a member of any other FbxCollectionExclusive
   * objects. \param pMember Object to be added
   */
