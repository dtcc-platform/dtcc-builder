...
public:
   ...
   * \return 0.0 if optical marker animation is valid by default, 1.0 if it is
   * occluded by default. \remarks This function only works if marker type is
   * set to FbxMarker::eOptical.
   */
  double GetDefaultOcclusion() const;

  /** Set default occlusion.
   * \param pOcclusion 0.0 if optical marker animation is valid by default, 1.0
   * if it is occluded by default. \remarks This function only works if marker
   * type is set to FbxMarker::eOptical.
   */
   ...
   * \remarks This function only works if marker type is set to
   * FbxMarker::eEffectorIK.
   */
  double GetDefaultIKReachTranslation() const;

  /** Set default IK reach translation.
   * \param pIKReachTranslation A value between 0.0 and 100.0, 100.0 means
   * complete IK reach. \remarks This function only works if marker type is set
   * to FbxMarker::eEffectorIK.
   */
   ...
   * \param pIKReachRotation A value between 0.0 and 100.0, 100.0 means complete
   * IK reach. \remarks This function only works if marker type is set to
   * FbxMarker::eEffectorIK.
   */
   ...
   * \param pIKPullHips A value between 0.0 and 100.0, 100.0 means complete IK
   * pull. \remarks This function only works if marker type is set to
   * FbxMarker::eIK_EFFECTOR.
   */
