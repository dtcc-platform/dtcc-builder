...
/** \brief This class deforms control points of a geometry using control point
 * positions stored in the associated cache object. \nosubgrouping
 */
...
public:
  ...
  enum ECacheChannelType
  {
    ...
    eUserDefined //!< This vertex cache deformer handles user specified data
                 //!< (the cache channel string can provide a hint)
  };
   ...
   * \return A pointer to the cache object used by this deformer, or \c NULL if
   * no cache object is assigned. */
