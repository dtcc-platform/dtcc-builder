...
/**	\brief This node attribute contains the properties of an optical
 * reference. \nosubgrouping Mainly used for optical motion capture systems.
 */
...
public:
  ...
  //! FbxNodeAttribute::EType::eOpticalReference.
