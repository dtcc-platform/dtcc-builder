...
public:
   ...
   * \return     \c true if at least one property is animated and \c false
   * otherwise. \remarks    A property is animated if it contains at least one
   * FbxAnimCurve with keys.
   */
   ...
   * \param pChannelName     Name of the specific channel of the inspected
   * property. \return                 \c true if the specified channel is
   * animated and \c false otherwise. \remarks                A property is
   * animated if it contains at least one FbxAnimCurve with keys.
   */
  ...
  public:
    ...
    bool operator==(CurveNodeIntfce &lRhs) { return (mImp == lRhs.mImp); }
  ...
  public:
    ...
    bool operator==(CurveIntfce &lRhs) { return (mImp == lRhs.mImp); }
  ...
  static int SplitAnimationIntoMultipleStacks(
      FbxScene *pScene,
