...
public:
  ...
  /** Set the clip color.
   * The color property can be used to display media clips on the user
   * interface. It has no impact on the data itself and only uses the RGB
   * components. \param pColor	New color of the clip.
   */
   ...
   * responsibility of the caller to deal with bad playback speed values.
   */
