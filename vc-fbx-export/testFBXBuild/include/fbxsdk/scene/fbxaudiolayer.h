 ...
 * a variable number of FbxAudio objects representing audio clips. The class
 * provides a Mute, Solo and Lock states flags (bool properties), as well as a
 * Clolor (double3 property). There is no evaluation system for audio layers
 * inside the FBX SDK and an audio layer can be empty. \nosubgrouping
 */
