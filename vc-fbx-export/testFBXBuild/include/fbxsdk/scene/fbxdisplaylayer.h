 ...
 * \nosubgrouping
 * Display layers are overlapping views of your scene that contain a list of
 * members. The members are exclusive. Members cannot be part of multiple
 * display layers. Display layers enables user to organize elements of scene and
 * affect visibility and manipulation attributes of multiple objects at once.
 */
