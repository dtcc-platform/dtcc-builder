...
public:
   ...
   * In this case, specific properties should be added to this one with the
   * Animatable flag set. \remarks By default, the Volume property is always
   * created first and, unless explicitily removed by a "client", will always
   * exist.
   */
  FbxProperty AnimFX;
  //@}
