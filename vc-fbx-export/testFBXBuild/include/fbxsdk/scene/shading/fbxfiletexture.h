...
public:
   ...
   *	\remarks            The texture file name must be valid, you cannot
   ...
   * \remarks            An empty string is returned if
   * FbxFileTexture::SetFileName() has not been called before.
   */
   ...
   * \remarks            An empty string is returned if
   * FbxFileTexture::SetRelativeFileName() has not been called before.
   */
