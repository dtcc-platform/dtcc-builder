...
public:
   ...
   * \return A valid table entry if pIndex is valid. Otherwise the value is
   * undefined.
   */
   ...
   */
  const FbxBindingTableEntry *
  GetEntryForDestination(const char *pDestName) const;
...
*****************************************************************************************************************************/
  ...
  // Remark: This method copies the mEntries table AND clears the UserData on
  // the resulting copy to prevent shared memory data between clones/copies.
