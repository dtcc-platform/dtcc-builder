...
public:
   ...
   * If this entry view corresponds with an valid entry which is not NULL, and
   * the entry type of this entry view is the same as that of the entry it
   * corresponds with, then this entry view is valid. \return     \c true if the
   * entry view is valid, \c false otherwise.
   */
  virtual bool IsValid() const;

  /** Create a new entry view.
   * \return     \c true if the entry view is created successfully, \c false
   * otherwise.
   */
  virtual bool Create();
