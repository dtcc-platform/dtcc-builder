...
public:
   ...
   *		DirectX
   *
   * \param pShadingAPIVersion a string containing the implementation API
   *version: eg. 1.0
   *
   * \param pShadingLanguage a string identifying the implementation language
   *name: GLSL	= GL Shading Language HLSL	= High Level Shading Language
   *		CGFX	= CG effect(NVidia)
   *		RIB		= RenderMan (RIB)
   *		etc...
   *
   * \param pShadingLanguageVersion a string identifying the implementation
   *language version: eg. 1.0
   *
