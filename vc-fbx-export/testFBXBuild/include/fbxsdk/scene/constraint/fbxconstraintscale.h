...
/**\brief This constraint class contains methods for accessing the properties of
 * a scale constraint. A scale constraint lets you constrain the scale of an
 * object based on the scale of one or more sources. \nosubgrouping
 */
