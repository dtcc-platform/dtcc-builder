...
/** The parent constraint creates a parent-to-child relationship between any two
 * objects, from any two hierarchies. It creates the same relationship as the
 * parent-to-child relationships found in hierarchies. You can use this
 * constraint to connect objects without changing hierarchies. \nosubgrouping
 */
...
public:
   ...
   */
  //@{
  /** This property handles whether to affect the translation of the constrained
   * object along X axis.
   *
  ...
  /** This property handles whether to affect the rotation of the constrained
   * object around X axis.
   *
   * Default value is true.
   */
  ...
  /** This property handles whether to affect the rotation of the constrained
   * object around Z axis.
   *
   * Default value is true.
   */
  FbxPropertyT<FbxBool> AffectRotationZ;

  /** This property handles whether to affect the scaling of the constrained
   * object along X axis.
   *
   * Default value is true.
   */
   ...
   * A constrained object is an object whose position, orientation, and so on is
   * driven by one or more constraint sources.
   */
