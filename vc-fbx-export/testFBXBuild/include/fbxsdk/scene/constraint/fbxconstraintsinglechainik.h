...
/** \brief This constraint class contains methods for accessing the properties
 * of a single chain IK constraint. \nosubgrouping
 */
...
public:
  ...
  /** If the constraints read its animation on Translation and Scale for the
   * nodes it constraints.
   */
  enum EEvaluationMode
  {
    eNeverTS,    //! The constraints never read its animation on translation and
                 //! scale for the nodes.
    eAutoDetect, //! The constraints read its animation on translation and scale
                 //! for the nodes according to automatic detection.
    eAlwaysTS //! The constraints always read its animation on translation and
              //! scale for the nodes.
  };
   ...
   * \param pWeight     Weight value of the source object expressed as a
   * percentage. \remarks           pWeight value is 100 percent by default.
   */
