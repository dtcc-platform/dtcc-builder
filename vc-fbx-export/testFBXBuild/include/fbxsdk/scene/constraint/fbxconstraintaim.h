...
/** An aim constraint governs an object's orientation so that the object points
 * to other objects. For example, you can use the aim constraint to point a
 * light at an object or group of objects. \nosubgrouping
 */
...
public:
  /** \enum EWorldUp Constraint world up type, which has the same meaning with
   * Maya.
   */
  enum EWorldUp
  {
  ...
  /** This property provides access to the object or objects which are the
   * targets.
   */
  ...
  /** This property enables you set a specific axis for the constrained object
   * to orient towards.
   *
