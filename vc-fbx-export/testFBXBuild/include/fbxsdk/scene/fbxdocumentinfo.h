...
public:
   ...
   * The default properties are listed below, but application vendors can add
   * new properties under this parent property.
   */
  FbxProperty Original;

  /** This property contains the name of the original application vendor.
   *
   * To retrieve the value of this property, use
   * Original_ApplicationVendor.Get(). To set the value of this property, use
   * Original_ApplicationVendor.Set(FbxString).
   *
   * The default value is empty.
   */
   ...
   * To set the value of this property, use
   * Original_ApplicationName.Set(FbxString).
   *
   * The default value is empty.
   */
   ...
   *
   * To retrieve the value of this property, use
   * Original_ApplicationVersion.Get(). To set the value of this property, use
   * Original_ApplicationVersion.Set(FbxString).
   *
   * The default value is empty.
   */
   ...
   * To set the value of this property, use
   * Original_DateTime_GMT.Set(FbxString).
   *
   ...
   *
   * To retrieve the value of this property, use
   * LastSaved_ApplicationVendor.Get(). To set the value of this property, use
   * LastSaved_ApplicationVendor.Set(FbxString).
   *
   * The default value is empty.
   */
   ...
   *
   * To retrieve the value of this property, use
   * LastSaved_ApplicationName.Get(). To set the value of this property, use
   * LastSaved_ApplicationName.Set(FbxString).
   *
   * The default value is empty.
   */
   ...
   *
   * To retrieve the value of this property, use
   * LastSaved_ApplicationVersion.Get(). To set the value of this property, use
   * LastSaved_ApplicationVersion.Set(FbxString).
   *
   * The default value is empty.
   */
   ...
   * To set the value of this property, use
   * LastSaved_DateTime_GMT.Set(FbxString).
   *
   * The default value is 0.
   *
   * \remarks The date/time should use GMT time format.
