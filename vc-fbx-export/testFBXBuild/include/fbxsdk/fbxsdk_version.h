 ...
 *
 * This file defines the version string and numbers for this release of the FBX
 * SDK. \note This file should never be included directly, please include
 * fbxsdk_def.h instead.
 */
...
#define FBXSDK_VERSION_NAME                                                    \
  "Release" //<! String, version name, example: Alpha, Beta, RC, Release
...
#define FBXSDK_VERSION_STRING                                                  \
  FBXSDK_VER_TO_STR(FBXSDK_VERSION_MAJOR, FBXSDK_VERSION_MINOR,                \
                    FBXSDK_VERSION_POINT)
#define FBXSDK_VERSION_STRING_FULL                                             \
  FBXSDK_VERSION_STRING " " FBXSDK_VERSION_NAME                                \
                        " (" FBX_STRINGIFY(FBXSDK_VERSION_REVISION) ")"
