...
typedef bool (*FbxProgressCallback)(void *pArgs,
                                    float pPercentage,
                                    const char *pStatus);
...
public:
   ...
   * \param pArgs Pointer to the optional arguments passed to the callback
   * function. */
   ...
   * \param pThreshold The threshold value, between 0.0 and 100.0, that triggers
   * the callback. \remark The default threshold is 1.0, meaning that every 1%
