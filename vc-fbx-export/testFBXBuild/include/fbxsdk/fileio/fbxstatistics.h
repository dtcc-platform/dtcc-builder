...
/**  This class is a basic class to get the quantity of items.
  *  User processes the statistics raw data by deriving FbxStatistics class and
  overrides \c AddItem method.
  *  When overriding \c AddItem method, User must store item's name and item's
  count by pair which means
  *  The index of one item's name in array \c mItemName is the same as the index
  of this item's count in array \c mItemCount.
  *
...
public:
   ...
   * \return				\c True if successful, \c False
   * otherwise.
   */
