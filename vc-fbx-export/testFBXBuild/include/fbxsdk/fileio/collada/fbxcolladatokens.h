...
#define COLLADA_TRANSLATE_ORIGIN                                               \
  "origin" // A fix for Poser(Bug 309548). Handle translate origin info exported
           // from Poser.
#define COLLADA_TRANSLATE_LOCATION                                             \
  "location" // A fix for ? (Bug BARB-154). "location" is synonyn of "translate"
             // ?
...
#define COLLADA_ROTATE_PIVOT                                                   \
  "rotatePivot" // the next 6 subids are recognized by ColladaMaya
...
#define COLLADA_PRE_ROTATION_X                                                 \
  "jointOrientX" // these 3 subids recognized by ColladaMaya
#define COLLADA_PRE_ROTATION_Y "jointOrientY"
#define COLLADA_PRE_ROTATION_Z "jointOrientZ"
#define COLLADA_POST_ROTATION_X                                                \
  "post-rotationX" // these 3 subids NOT recognized by ColladaMaya
#define COLLADA_POST_ROTATION_Y "post-rotationY"
#define COLLADA_POST_ROTATION_Z "post-rotationZ"
#define COLLADA_ROTATE_AXIS_X                                                  \
  "rotateAxisX" // these 3 subids recognized by ColladaMaya
...
#define COLLADA_RGB_INPUT                                                      \
  "COLORRGB" // beta MAX exporter has been known to generate them
#define COLLADA_RGBA_INPUT                                                     \
  "COLORRGBA" // beta MAX exporter has been known to generate them
