...
{
public:
  FbxWriterFbx6(FbxManager &pManager,
...
private:
  ...
  void BuildObjectDefinition(FbxDocument *pDocument,
                             Fbx6TypeDefinition &pDefinitions);
  void SetObjectWriteSupport(const Fbx6TypeDefinition &pDefinitions);
  bool WriteDescriptionSection(FbxDocument *pDocument);
  bool WriteReferenceSection(FbxDocument *pDocument,
                             Fbx6TypeWriteReferences &pReferences);
  void WriteObjectDefinition(FbxDocument *pDocument,
                             Fbx6TypeDefinition &pDefinitions);
  void WriteObjectProperties(FbxDocument *pDocument,
                             Fbx6TypeDefinition &pDefinitions);

  void FlattenDocument(FbxDocument *pDocument,
                       Fbx6TypeObjectHierarchy &pDocHierarchy,
                       bool pFirstCall = true);
  void UnFlattenDocument(FbxDocument *pDocument,
                         Fbx6TypeObjectHierarchy &pDocHierarchy);
  bool WriteObjectHeaderAndReferenceIfAny(FbxObject &pObj,
                                          const char *pObjectType) const;
  ...
  void WriteCharacterLinkGroup(FbxCharacter &pCharacter,
                               int pCharacterGroupId,
                               FbxScene &pScene);
  void WriteCharacterLink(FbxCharacter &pCharacter,
  ...
  bool
  WriteShape(FbxShape &pShape, FbxString pShapeName, FbxGeometry &pGeometry);
  ...
  bool WriteFbxLayerElementNormals(FbxLayerContainer &pLayerContainer,
                                   FbxMultiMap &);
  bool WriteFbxLayerElementBinormals(FbxLayerContainer &pLayerContainer,
                                     FbxMultiMap &);
  bool WriteFbxLayerElementTangents(FbxLayerContainer &pLayerContainer,
                                    FbxMultiMap &);
  bool WriteFbxLayerElementMaterials(FbxLayerContainer &pLayerContainer,
                                     FbxMultiMap &);
  bool WriteFbxLayerElementTextures(FbxLayerContainer &pLayerContainer,
                                    FbxMultiMap &);
  bool WriteFbxLayerElementTexturesChannel(FbxLayerContainer &pLayerContainer,
                                           FbxLayerElement::EType pTextureType,
                                           FbxMultiMap &pLayerIndexSet);
  bool WriteFbxLayerElementUVsChannel(FbxLayerContainer &pLayerContainer,
                                      FbxLayerElement::EType pTextureType,
                                      FbxMultiMap &pLayerIndexSet);

  bool WriteFbxLayerElementPolygonGroups(FbxLayerContainer &pLayerContainer,
                                         FbxMultiMap &);
  bool WriteFbxLayerElementVertexColors(FbxLayerContainer &pLayerContainer,
                                        FbxMultiMap &);
  bool WriteFbxLayerElementUVs(FbxLayerContainer &pLayerContainer,
                               FbxMultiMap &);
  bool WriteFbxLayerElementSmoothing(FbxLayerContainer &pLayerContainer,
                                     FbxMultiMap &);
  bool WriteFbxLayerElementUserData(FbxLayerContainer &pLayerContainer,
                                    FbxMultiMap &);
  bool WriteFbxLayerElementVisibility(FbxLayerContainer &pLayerContainer,
                                      FbxMultiMap &);
  bool WriteFbxLayerElementVertexCrease(FbxLayerContainer &pLayerContainer,
                                        FbxMultiMap &);
  bool WriteFbxLayerElementEdgeCrease(FbxLayerContainer &pLayerContainer,
                                      FbxMultiMap &);
  bool WriteFbxLayerElementHole(FbxLayerContainer &pLayerContainer,
                                FbxMultiMap &);

  bool WriteLayers(FbxLayerContainer &pLayerContainer, FbxMultiMap &);
  int MapLayeredTextureIndexToConnectionIndex(FbxNode *pNode,
                                              void *pLET,
                                              int pIndex);
  ...
  // Write Connections
  bool WriteFieldConnection(FbxDocument *pDocument,
                            FbxObject *pSrcObject,
                            FbxDocument *pDstDocument);
  bool WriteFieldConnection(FbxDocument *pDocument,
                            FbxObject *pSrc,
                            FbxObject *pDst);
  bool WriteFieldConnection(FbxDocument *pDocument,
  ...
  bool WriteFCurves(FbxObject &pObject,
                    FbxAnimLayer *pAnimLayer,
                    const char *pBlockName,
                    bool pKeepBlockOpen = false,
                    bool pRescaleShininess = false);
...
private:
  ...
  void ReplaceUnsupportedProperties(FbxScene *pScene,
