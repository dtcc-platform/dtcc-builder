...
private:
  ...
  bool ReadDefinitionSection(FbxScene &pScene,
                             FbxArray<Fbx5ObjectTypeInfo *> &pObjectContent);
  bool ReadObjectSection(FbxScene &pScene,
                         FbxArray<Fbx5ObjectTypeInfo *> &pObjectContent);
  bool ReadObject(FbxScene &pScene,
  ...
  void ReadControlSetLinkGroup(FbxControlSet &pControlSet,
  ...
  bool ReadLayerElementsUV(FbxGeometry *pGeometry,
  ...
  void TransferAnimation(void *pRootCurveNode,
                         FbxProperty &pRootProperty,
                         bool pValueOnly = false);
