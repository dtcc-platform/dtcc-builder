...
public:
  ...
  /** If this property is root property, delete the property page, otherwise
   * delete the property. \return  If succeed, return true. */
  bool Destroy();
   ...
   * \param pCheckReferences Decide whether check instance. If it is true, check
   * instance. \return The inheritance type */
  FbxPropertyFlags::EInheritType
  GetFlagsInheritType(FbxPropertyFlags::EFlags pFlags,
                      bool pCheckReferences) const;

  /**	According the given parameter Change the attributes of the property.
   * \param pFlags The given flags used as mask.
   * \param pValue If pValue is true, set mask with given flags, otherwise unset
   * mask with given flags. \return  If succeed, return true. */
  ...
  /** Set parent property handle.No matter what enters,the result is always
   * false. \param pOther \return False */
  ...
  /** Get parent property
   * \return If the parent property exists, return the property handle,otherwise
   * return -1. */
  FbxPropertyHandle GetParent() const;

  /**  Get child property
   * \return  If the child property is exist, return the property
   * handle,otherwise return -1. */
  FbxPropertyHandle GetChild() const;

  /**  Get sibling property
   * \return If the sibling property is exist, return the property
   * handle,otherwise return -1. */
  FbxPropertyHandle GetSibling() const;

  /**  Get first descendent property
   * \return If the descendent property is exist, return the first descendent
   * property handle,otherwise return -1. */
  ...
  /** Separate the given name by  children separator string and then find the
   * property.The step is strip the first part of the name and search, if the
   * property can be found, strip the second part of the name and continue
   * search, until no property be found,then return the last found property.
   * \param pName The given property name
   ...
   * \param pFilter    The filter used to get sub connection point. If it is not
   * zero, return the source count of the sub connection point. Otherwise,
   * return the src count of this property. \return The count of source
   * properties */
  int GetSrcCount(FbxConnectionPointFilter *pFilter = 0) const;

  /** Get source property with the given index.
   * \param pFilter    The filter used to get sub connection point. If it is not
   * zero, return the source property of the sub connection point. Otherwise,
   * return the source property of this property. \param pIndex    The given
   * index \return The source property handle. */
   ...
   * \param pFilter    The filter used to get sub connection point.If it is not
   * zero,return the destination count of the sub connection point. Otherwise,
   * return the destination count of this property. \return The count of
   * destination properties */
  int GetDstCount(FbxConnectionPointFilter *pFilter = 0) const;

  /** Get destination property with the given index.
   * \param pFilter    The filter used to get sub connection point.If it is not
   * zero,return the destination property of the sub connection point.
   ...
   * retrieve limits from files, and will assure that they are persistent in
   * memory while the property handle object exists.
   *
   * Soft minimums and maximums values are specifying a second set of limits
   * that can be used for UI objects such as sliders. FBX will handle them the
   * same way it does with the normal limits. */
  //@{
  ...
  /** According the given value and its value type, set the minimum value and
   * value type for this property. \param pValue    The given value . \return If
   * it be set successfully, return true,otherwise, return false.
   */
  template <class T> inline bool SetMin(const T &pValue)
  {
  ...
  template <class T> inline T GetMin(const T *pFBX_TYPE) const
  {
    T lValue;
   ...
   * \return If the soft minimum value exist, return true,otherwise, return
   * false. */
  ...
  /** According the given value and its value type, set the soft minimum value
   * and value type for this property. \param pValue    The given value .
   * \return If it be set successfully, return true,otherwise, return false. */
  template <class T> inline bool SetSoftMin(const T &pValue)
  {
  ...
  template <class T> inline T GetSoftMin(const T *pFBX_TYPE) const
  {
    T lValue;
  ...
  /** According the given value and its value type, set the maximum value and
   * value type for this property. \param pValue    The given value .
   * \return If it be set successfully, return true,otherwise, return false. */
  template <class T> inline bool SetMax(const T &pValue)
  {
  ...
  template <class T> inline T GetMax(const T *pFBX_TYPE) const
  {
    T lValue;
   ...
   * \return If the soft maximum value exist, return true,otherwise, return
   * false. */
  ...
  /** According the given value and its value type, set the soft maximum value
   * and value type for this property. \param pValue    The given value .
   * \return If it be set successfully, return true,otherwise, return false. */
  template <class T> inline bool SetSoftMax(const T &pValue)
  {
  ...
  template <class T> inline T GetSoftMax(const T *pFBX_TYPE) const
  {
    T lValue;
   ...
   * \param pCheckReferences   If it is true,check instance of this property
   * page,otherwise,only check this page.
   * \return The value inherit type of this property */
  FbxPropertyFlags::EInheritType
  GetValueInheritType(bool pCheckReferences) const;
   ...
   * \return If default value be gotten successfully, return true,otherwise,
   * return false. */
   ...
   * \return If value be gotten successfully, return true,otherwise, return
   * false. */
   ...
   * \param pCheckValueEquality If it is true, when the given value is equal
   * with the property value, the property value will not be set.
   * \return If the property value be set successfully, return true,otherwise,
   * return false. */
  ...
  template <class T> inline T Get(const T *pFBX_TYPE) const
  {
    T lValue;
   ...
   * \return If this property page is a instance of other page, return
   ...
   * \return If this property page is referenced by other pages, return
   * true,otherwise,return false. */
  bool IsReferencedBy(void) const;

  /** Get the count of property pages which make reference to this property
   * page. \return The count of property pages which make reference to this
   * property page. */
  int GetReferencedByCount(void) const;

  /** According the given index,get the property page which make reference to
   * this property page. \param pIndex The given index \return The pointer to
   * the property page which reference to this property page and be found by
   * index. */
