 ...
 * module. \param pModuleHandle A valid module handle. \param pProcName The
 * procedure name to search. \return The procedure handle if valid, otherwise
 * NULL.
 */
 ...
 * \remark When the reference count reaches zero, the module is unloaded from
