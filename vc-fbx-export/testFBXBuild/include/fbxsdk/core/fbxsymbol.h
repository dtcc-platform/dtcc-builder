...
/** Defines a symbol string. A symbol string is a string that is unique and
 * stored in a global symbol table. \nosubgrouping */
 ...
 * /remarks Each symbol is unique. That means there are no symbols which have
 * the same name. \nosubgrouping */
...
public:
   ...
   */
  inline bool IsEmpty() const { return !mItem || mItem->GetKey().IsEmpty(); }
