 ...
 * \remark Output buffer should be release by caller */
FBXSDK_DLL void FbxWCToAnsi(const wchar_t *pInWideChar,
                            char *&pOutANSI,
                            size_t *pOutANSISize = NULL);
 ...
 * \param pOutWideCharSize size of the allocated output string buffer
 * \remark Output buffer should be release by caller */
FBXSDK_DLL void FbxAnsiToWC(const char *pInANSI,
                            wchar_t *&pOutWideChar,
                            size_t *pOutWideCharSize = NULL);
 ...
 * \param pOutUTF8Size size of the allocated output string buffer
 * \remark Output buffer should be release by caller */
FBXSDK_DLL void FbxAnsiToUTF8(const char *pInANSI,
                              char *&pOutUTF8,
                              size_t *pOutUTF8Size = NULL);
 ...
 * \param pOutANSISize size of the allocated output string buffer
 * \remark Output buffer should be release by caller */
FBXSDK_DLL void FbxUTF8ToAnsi(const char *pInUTF8,
                              char *&pOutANSI,
                              size_t *pOutANSISize = NULL);
#endif
...
public:
   ...
   * \param pNbRepeat The number of times to repeat the character. Default value
   * is 1 */
  ...
  friend FBXSDK_DLL FbxString operator+(const FbxString &pString1,
  ...
  friend FBXSDK_DLL FbxString operator+(const char *pString1,
                                        const FbxString &pString2);
  ...
  friend FBXSDK_DLL FbxString operator+(const FbxString &pString,
                                        double pValue);
   ...
   * \param pPadding The padding type.
   * \param pCar The character to be padded.
   * \remark If pCar == '\0' the function will remove all the characters that
   * are tested by isspace(). */
...
private:
  ...
  FbxString(size_t pSrc1Len,
            const char *pSrc1Data,
            size_t pSrc2Len,
            const char *pSrc2Data); // Previously ConcatCopy
  void Init();
  ...
  bool InternalFindAndReplace(const char *pFind,
                              const char *pReplaceBy,
