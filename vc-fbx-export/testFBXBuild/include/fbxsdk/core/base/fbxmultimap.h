...
public:
   ...
   * \param pKey The value of Key in new item, also is the character for
   * matching. \param pItem The value of Item in new item. \return If add
   ...
   * \remarks If there are multiple elements that match the character, the index
  ...
  /** Swap the value of Key and Item in every item of array, and sort the new
   * array with the value of Key. */
  void Swap();
