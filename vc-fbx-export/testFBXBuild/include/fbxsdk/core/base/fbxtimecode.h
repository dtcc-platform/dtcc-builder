...
#define FBXSDK_TC_MNTSC_1798_FRAMES                                            \
  FbxLongLong(FBXSDK_TC_MNTSC_FRAME * 1798) // leap minute
#define FBXSDK_TC_MNTSC_1800_FRAMES                                            \
  FbxLongLong(FBXSDK_TC_MNTSC_FRAME * 1800) // ~1 minute
#define FBXSDK_TC_MNTSC_17982_FRAMES                                           \
  FbxLongLong(FBXSDK_TC_MNTSC_FRAME * 17982) // ~10 minutes
#define FBXSDK_TC_MNTSC_107892_FRAMES                                          \
  FbxLongLong(FBXSDK_TC_MNTSC_FRAME * 107892) // ~1 hour
#define FBXSDK_TC_MNTSC_108000_FRAMES                                          \
  FbxLongLong(FBXSDK_TC_MNTSC_FRAME * 108000)

// For 29.9700299700 non-drop, btw : same values as with 23.976
#define FBXSDK_TC_MNTSC_1_SECOND                                               \
  FbxLongLong(FBXSDK_TC_MNTSC_FRAME * 30) // 1 frame * 30
#define FBXSDK_TC_MNTSC_1_MINUTE                                               \
  FbxLongLong(FBXSDK_TC_MNTSC_1_SECOND * 60) // 1 minute (1800 frames)
#define FBXSDK_TC_MNTSC_1_HOUR                                                 \
  FbxLongLong(FBXSDK_TC_MNTSC_1_SECOND * 3600) // 1 hour
...
#define FBXSDK_TC_MFILM_1_SECOND                                               \
  FbxLongLong(FBXSDK_TC_MFILM_FRAME * 24) // 1 frame * 24
#define FBXSDK_TC_MFILM_1_MINUTE                                               \
  FbxLongLong(FBXSDK_TC_MFILM_1_SECOND * 60) // 1 minute (1440 frames)
#define FBXSDK_TC_MFILM_1_HOUR                                                 \
  FbxLongLong(FBXSDK_TC_MFILM_1_SECOND * 3600) // 1 hour
...
#define FBXSDK_TC_HOUR_REM(quot, num, den)                                     \
  ((quot) = ((num - (-FbxLongLong(num < 0) & (den - 1))) / (den)),             \
   (quot) * (den))
...
FBXSDK_DLL FbxLongLong FbxTCSetRate(int pHour,
                                    int pMinute,
                                    int pSecond,
                                    FbxLongLong pFrame,
                                    FbxLongLong pPeriod);
FBXSDK_DLL FbxLongLong FbxTCGetRate(FbxLongLong pTime,
                                    int &pHour,
                                    int &pMinute,
                                    int &pSecond,
                                    int &pFrame,
                                    FbxLongLong pPeriod);
FBXSDK_DLL FbxLongLong FbxTCSetNTSC(
    int pHour, int pMinute, int pSecond, FbxLongLong pFrame, int pField);
FBXSDK_DLL FbxLongLong FbxTCGetNTSC(FbxLongLong pTime,
                                    int &pHour,
                                    int &pMinute,
                                    int &pSecond,
                                    int &pFrame,
                                    int &pField);
FBXSDK_DLL FbxLongLong FbxTCSetMNTSCnd(
    int pHour, int pMinute, int pSecond, FbxLongLong pFrame, int pField);
FBXSDK_DLL FbxLongLong FbxTCGetMNTSCnd(FbxLongLong pTime,
                                       int &pHour,
                                       int &pMinute,
                                       int &pSecond,
                                       int &pFrame,
                                       int &pField);
FBXSDK_DLL FbxLongLong FbxTCSetMNTSC_2Xnd(
    int pHour, int pMinute, int pSecond, FbxLongLong pFrame, int pField);
FBXSDK_DLL FbxLongLong FbxTCGetMNTSC_2Xnd(FbxLongLong pTime,
                                          int &pHour,
                                          int &pMinute,
                                          int &pSecond,
                                          int &pFrame,
                                          int &pField);
FBXSDK_DLL FbxLongLong FbxTCSetMNTSC(
    int pHour, int pMinute, int pSecond, FbxLongLong pFrame, int pField);
FBXSDK_DLL FbxLongLong FbxTCGetMNTSC(FbxLongLong pTime,
                                     int &pHour,
                                     int &pMinute,
                                     int &pSecond,
                                     int &pFrame,
                                     int &pField);
FBXSDK_DLL FbxLongLong FbxTCSetPAL(
    int pHour, int pMinute, int pSecond, FbxLongLong pFrame, int pField);
FBXSDK_DLL FbxLongLong FbxTCGetPAL(FbxLongLong pTime,
                                   int &pHour,
                                   int &pMinute,
                                   int &pSecond,
                                   int &pFrame,
                                   int &pField);
FBXSDK_DLL FbxLongLong FbxTCSetFILM(int pHour,
                                    int pMinute,
                                    int pSecond,
                                    FbxLongLong pFrame);
FBXSDK_DLL FbxLongLong FbxTCGetFILM(
    FbxLongLong pTime, int &pHour, int &pMinute, int &pSecond, int &pFrame);
FBXSDK_DLL FbxLongLong FbxTCSetFILMND(
    int pHour, int pMinute, int pSecond, FbxLongLong pFrame, int pField);
FBXSDK_DLL FbxLongLong FbxTCGetFILMND(FbxLongLong pTime,
                                      int &pHour,
                                      int &pMinute,
                                      int &pSecond,
                                      int &pFrame,
