 ...
 *
 * Instead of overloading the operator new in the FBX SDK, we provide a set of
 * templates that are used internally to create objects. This mechanic allows
 * the FBX SDK to call a different memory allocator. \see FbxSetMallocHandler
 * FbxSetCallocHandler FbxSetReallocHandler FbxSetFreeHandler FbxSetMSizeHandler
 */
...
#pragma warning(push)
#pragma warning(disable : 4345) // warning C4345: behavior change: an object of
                                // POD type constructed with an initializer of
...
template <typename T> struct FbxSimpleType
{
  enum
  {
    value = 0
...
template <typename T> struct FbxSimpleType<T *>
{
  enum
  {
    value = 1
...
template <typename T> struct FbxSimpleType<const T>
{
  enum
  {
...
template <typename T, size_t n> struct FbxSimpleType<T[n]>
{
  enum
  {
    value = FbxSimpleType<T>::value
...
#define FBXSDK_DEFINE_SIMPLE_TYPE(T)                                           \
  template <> struct FbxSimpleType<T>                                          \
  {                                                                            \
    union {                                                                    \
      T t;                                                                     \
    } catcherr;                                                                \
...
#define FBXSDK_FRIEND_NEW()                                                    \
  template <typename T> friend T *FBXSDK_NAMESPACE::FbxNew();                  \
  ...
  friend T *FBXSDK_NAMESPACE::FbxNew(const T1 &p1, const T2 &p2, const T3 &p3, \
                                     const T4 &p4, const T5 &p5, const T6 &p6, \
                                     const T7 &p7, const T8 &p8);              \
  template <typename T, typename T1, typename T2, typename T3, typename T4,    \
            typename T5, typename T6, typename T7, typename T8, typename T9>   \
  friend T *FBXSDK_NAMESPACE::FbxNew(                                          \
      const T1 &p1, const T2 &p2, const T3 &p3, const T4 &p4, const T5 &p5,    \
      const T6 &p6, const T7 &p7, const T8 &p8, const T9 &p9);                 \
  template <typename T> friend void FBXSDK_NAMESPACE::FbxDelete(T *p);         \
  template <typename T> friend void FBXSDK_NAMESPACE::FbxDelete(const T *p);   \
  template <typename T> friend T *FBXSDK_NAMESPACE::FbxNewArray(const int n);  \
  template <typename T> friend void FBXSDK_NAMESPACE::FbxDeleteArray(T *p);
