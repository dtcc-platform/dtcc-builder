...
public:
   ...
   * \return           A new vector with the result of adding pValue to each
   * component of this vector. \remarks          The pValue parameter is not
   * checked.
   */
   ...
   * \return           A new vector with the result of subtracting pValue from
   * each component of this vector. \remarks          The pValue parameter is
   * not checked.
   */
  FbxVector2 operator-(double pValue) const;
   ...
   * \return           A new vector with the result of multiplying each
   * component of this vector by pValue. \remarks          The pValue parameter
   * is not checked.
   */
  FbxVector2 operator*(double pValue) const;
   ...
   * \return           A new vector with the result of dividing each component
   * of this vector by pValue. \remarks          The pValue parameter is not
   * checked.
   */
  FbxVector2 operator/(double pValue) const;
  ...
  /** Add a value to all vector components.
   * \param pValue The value to add to each component of the vector.
   * \return           The result of adding pValue to each component of this
   * vector, replacing this vector. \remarks          The pValue parameter is
   * not checked.
   */
   ...
   * this vector, replacing this vector. \remarks          The pValue parameter
   * is not checked.
   */
  FbxVector2 &operator-=(double pValue);
   ...
   * \param pValue The value multiplying each component of the vector.
   * \return           The result of multiplying each component of this vector
   * by pValue, replacing this vector. \remarks          The pValue parameter is
   * not checked.
   */
  FbxVector2 &operator*=(double pValue);
  ...
  /** Add two vectors together.
   * \param pVector Vector to add.
   * \return            The result of this vector + pVector, replacing this
   * vector. \remarks           The values in pVector are not checked.
   */
   ...
   * \return            \c true if the two vectors are equal (each element is
   ...
   * \param pVector The vector to be compared to \e this.
   * \return            \c false if the two vectors are equal (each element is
   ...
   * \param pSize The number of element to test, starting at beginning. Value
   * must range between [1, 2]. \return \c true if all elements of the vector
   * are zero, \c false otherwise. */
