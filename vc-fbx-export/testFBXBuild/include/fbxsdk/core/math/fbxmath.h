...
#define FBXSDK_EULER_DEGENERATE                                                \
  FbxEuler::DegenerateThreshold() //!< Euler degenerate threshold can be changed
                                  //!< with a call to
...
enum EFbxQuatInterpMode
{
  ...
  eQuatInterpTangentDependent, //!< Mix between Slerp and cubic interpolation,
                               //!< depending on the specified tangents for each
                               //!< key.
...
inline bool FbxEqual(const FbxDouble2 &x,
                     const FbxDouble2 &y,
...
inline bool FbxEqual(const FbxDouble3 &x,
                     const FbxDouble3 &y,
                     const double e = FBXSDK_TOLERANCE)
{
  return (FbxEqual(x.mData[0], y.mData[0], e) &&
...
inline bool FbxEqual(const FbxDouble4 &x,
                     const FbxDouble4 &y,
                     const double e = FBXSDK_TOLERANCE)
{
  return (FbxEqual(x.mData[0], y.mData[0], e) &&
...
inline bool FbxEqual(const FbxDouble4x4 &x,
...
inline bool FbxEqual(const FbxVector2 &x,
                     const FbxVector2 &y,
                     const double e = FBXSDK_TOLERANCE)
{
  return (FbxEqual(x.mData[0], y.mData[0], e) &&
...
inline bool FbxEqual(const FbxVector4 &x,
                     const FbxVector4 &y,
                     const double e = FBXSDK_TOLERANCE)
{
  return (FbxEqual(x.mData[0], y.mData[0], e) &&
...
inline bool FbxEqual(const FbxMatrix &x,
                     const FbxMatrix &y,
                     const double e = FBXSDK_TOLERANCE)
{
  return (FbxEqual(x[0], y[0], e) && FbxEqual(x[1], y[1], e) &&
...
inline bool FbxEqual(const FbxAMatrix &x,
                     const FbxAMatrix &y,
                     const double e = FBXSDK_TOLERANCE)
{
  return (FbxEqual(x[0], y[0], e) && FbxEqual(x[1], y[1], e) &&
...
template <class T> inline T FbxReciprocal(const T x) { return T(1) / x; }
