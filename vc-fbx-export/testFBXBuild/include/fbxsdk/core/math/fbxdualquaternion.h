...
/**	FBX SDK dual quaternion class to represent rigid transformation, which
 * is combined by two quaternions. A transformation is said to be rigid if it
 * preserves relative distances and angles. That means rotation and translation.
 * \nosubgrouping
 */
...
public:
  ...
  /** Constructor.
   * \param pRotation     The rotation the dual quaternion is going to
   * represent. \param pTranslation  The translation the dual quaternion is
   * going to represent.
   */
   ...
   * \remarks A dual quaternion can represent rotation followed by translation,
   * or translation followed by rotation. This method assumes that the rotation
   * is expressed first, followed by translation, as is done by most DCC tools.
   */
  ...
  /** Add a value to all vector components.
   * \param pValue     The value to add to each component of the vector.
   * \return           The result of adding pValue to each component of the
   * vector, replacing this dual quaternion. \remarks          The passed value
   * is not checked.
   */
  ...
  /** Subtract a value from all vector components.
   * \param pValue     The value to subtract from each component of the vector.
   * \return           The result of subtracting pValue from each component of
   * the vector, replacing this dual quaternion. \remarks          The passed
   ...
   * pValue, replacing this dual quaternion. \remarks          The passed value
   * is not checked.
   */
  FbxDualQuaternion &operator*=(double pValue);
   ...
   * \param pDualQuaternion     Dual quaternion to add.
   * \return                The dual quaternion v' = this + pQuaternion,
   * replacing this dual quaternion. \remarks               The values in
   * pDualQuaternion are not checked.
   */
  FbxDualQuaternion &operator+=(const FbxDualQuaternion &pDualQuaternion);
   ...
   * \return            The dual quaternion v' = FbxDualQuaternion(mQ1, (mQ1 *
   * pVector) + mQ2). \remarks           The values in pDualQuaternion are not
   * checked.
   */
