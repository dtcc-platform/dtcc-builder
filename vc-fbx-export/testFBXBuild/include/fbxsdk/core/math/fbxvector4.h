...
public:
  ...
  /** Assignment operation.
   * \param pValue    The pointer to an array whose elements are assigned to
   * this vector. \return          This vector after assignment.
   */
   ...
   * \return          This vector after assignment.
   * \remarks         The first three elements are assigned with pValue. The
   * fourth element is set as 1.0
   */
   ...
   * \remarks           Being considered as a XYZ vector with a weight, only the
   * 3 first elements are considered in this operation.
   */
   ...
   * \remarks           Being considered as a XYZ vector with a weight, only the
   * first 3 elements are considered in this operation.
   */
   ...
   * \remarks     Being considered as a XYZ vector with a weight, only the first
   * 3 elements are considered in this operation.
   */
  double Length() const;
   ...
   * must range between [1, 4]. \return \c true if all elements of the vector
