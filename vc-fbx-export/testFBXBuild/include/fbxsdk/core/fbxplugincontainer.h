...
public:
  ...
  /** The registration function that must be called when the module containing
   * the plug-in is loaded. \param pPlugin The plug-in to register.
   */
  void Register(FbxPlugin &pPlugin);

  /** The unregistration function that must be called when the module containing
   * the plug-in is unloaded. \param pPlugin The plug-in to unregister.
   */
