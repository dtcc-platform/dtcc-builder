...
def check_volume_mesh(volume_mesh: VolumeMesh):
    ...
    info(volume_mesh)
    info("Cell based quality metrics for volume mesh")
    

    v = TetrahedronMeshQuality.volume(volume_mesh)
    info("Tetrahedron Element Volume")
    ...
    info("Tetrahedron Element Quality")
    ...
    info("Optimal Cell Size Skewness")
    ...
    info("Face based quality metrics for volume mesh")
