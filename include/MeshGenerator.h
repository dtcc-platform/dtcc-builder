...
public:
  ...
  // building shape. The domain markers are adjusted so that cells that
  // are above a building (but not touching the building or the top) are
  // are marked as -4.
                         ...
                         size_t numLayers)
  {
    ...
    {
      warning("MeshGenerator: Building " + str(marker) +
