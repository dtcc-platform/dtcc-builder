...
namespace DTCC_BUILDER
{
  ...
  public:
    ...
    Vector2D operator()(const Point2D& p) const override
    {
      ...
      Vector2D v{};
      v.x = DTCC_BUILDER::Grid2D::Interpolate(x, y, v00x, v10x, v01x, v11x);
      v.y = DTCC_BUILDER::Grid2D::Interpolate(x, y, v00y, v10y, v01y, v11y);
  ...
  public:
    ...
    Vector3D operator()(const Point3D& p) const override
    {
      ...
      Vector3D v;
      v.x = DTCC_BUILDER::Grid3D::Interpolate(
          x, y, z, v000x, v100x, v010x, v110x, v001x, v101x, v011x, v111x);
      v.y = DTCC_BUILDER::Grid3D::Interpolate(
          x, y, z, v000y, v100y, v010y, v110y, v001y, v101y, v011y, v111y);
      v.z = DTCC_BUILDER::Grid3D::Interpolate(
          x, y, z, v000z, v100z, v010z, v110z, v001z, v101z, v011z, v111z);
