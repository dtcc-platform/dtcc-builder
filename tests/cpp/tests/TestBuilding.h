...
TEST_CASE("Point converage")
{
  ...
  building.roof_points.push_back(Point3D(0.51, 0.51, 0));
  building.roof_points.push_back(Point3D(0.52, 0.52, 0));
  building.roof_points.push_back(Point3D(0.53, 0.53, 0));

  building.roof_points.push_back(Point3D(1.5, 0.5, 0));
  building.roof_points.push_back(Point3D(1.5, 1.5, 0));
