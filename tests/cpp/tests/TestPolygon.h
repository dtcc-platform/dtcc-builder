...
TEST_CASE("Polygon Geometry")
{
  ...
  SECTION("Point in Polygon")
  {
    ...
    REQUIRE(Geometry::polygon_contains_2d(polygon, Point2D(0, 0)));
    REQUIRE(Geometry::polygon_contains_2d(polygon, Point2D(1, 1)));
    REQUIRE(!Geometry::polygon_contains_2d(polygon, Point2D(1.5, 2.5)));
  }
